      ...
      <div className="py-12 bg-gray-900">
        ...
        <div className="mt-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
            {featureCourses.map((course: Courses) => (
        ...
        <div className="mt-10 text-center">
          <Link
            href={"/courses"}
            className="p-3 rounded-md border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 transition duration-200
          "
          >
            View All Courses
          </Link>
